...
public class AddColorValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (color.equals("")) {
			...
			if (color.getColorName().trim().equals("")) {
				...
				errors.rejectValue("colorName",
						"error.not-number-colorName", null,
						"Value required.");
				...
				errors.rejectValue("colorCode",
						"error.not-start-colorcode", null,
						"Value required.");
			} else if (!(color.getColorCode().trim().length() == 7)) {
				errors.rejectValue("colorCode",
						"error.not-length-colorcode", null,
						"Value required.");
			}
		}
	}
