...
public class UpdateProductValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (prod.equals("")) {
			errors.rejectValue("productName", "error.not-specified-value",
					null, "Value required.");
		}

		else {
			if (prod.getName().equals("")) {
				errors.rejectValue("name", "error.not-specified-name",
						null, "Value required.");
				...
				errors.rejectValue("weight",
						"error.not-specified-weight", null, "Value required.");
				...
				errors.rejectValue("price", "error.not-specified-price",
						null, "Value required.");
			}
				...
				errors.rejectValue("stock", "error.not-specified-stock",
						null, "Value required.");
			}
